...
class ClientSaveRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'resturant_name_slug'   => 'required|string|unique:clients,resturant_name_slug',
    ...
    public function messages()
    {
        return [
            ...
            'resturant_name_slug.required'  => 'Resturant Name Slug is Required',
            'resturant_name_slug.required'  => 'Provide Valid Resturant Name Slug',
            'resturant_name_slug.unique'    => 'Resturant Name Slug Already Exist',
            'resturant_location.string'     => 'Resturant Location is Required.',
