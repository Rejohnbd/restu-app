        ...
        <div class="col-md-9">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#addDocument" data-toggle="tab">Menu Attach</a></li>
                </ul>
                <div class="tab-content">
                            ...
                            <ul class="mailbox-attachments clearfix">
                                ...
                                <li>
                                    ...
                                    <div class="mailbox-attachment-info">
                                        ...
                                        <span class="mailbox-attachment-size">
                                            <a href="{{ $client->resturant_menu == 'default_menu.pdf' ? asset('img/default_logo.png') : asset('storage/' . $client->resturant_menu) }}" class="btn btn-default btn-xs pull-right" download=""><i class="fa fa-cloud-download"></i></a>
                                        </span>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="tab-pane" id="addDocument">
                        <form id="uploadMenu" class="form-horizontal" action="javascript:void(0)" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="resturantMenu" class="col-sm-2 control-label">Menu Upload</label>
                                <div class="col-sm-3">
                                    <input type="file" name="resturant_menu" class="form-control" id="resturantMenu">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" class="btn btn-primary pull-right">Upload Menu</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    $(document).ready(function() {
        $('#uploadMenu').submit(function() {
            var formData = new FormData(this);
            $.ajax({
                type: 'POST',
                url: '{{ route("menus-upload") }}',
                processData: false,
                contentType: false,
                data: formData,
